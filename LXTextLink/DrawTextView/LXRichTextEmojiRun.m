...
{
    return [[NSArray arrayWithObjects:@"[微笑]", @"[撇嘴]", @"[色]", @"[发呆]", @"[得意]", @"[流泪]", @"[害羞]", @"[闭嘴]", @"[睡]", @"[大哭]", @"[尴尬]", @"[发怒]", @"[调皮]", @"[呲牙]", @"[惊讶]", @"[难过]", @"[酷]", @"[冷汗]", @"[抓狂]", @"[吐]", @"[偷笑]", @"[可爱]", @"[白眼]", @"[傲慢]", @"[饥饿]", @"[困]", @"[惊恐]", @"[流汗]", @"[憨笑]", @"[大兵]", @"[奋斗]", @"[咒骂]", @"[疑问]", @"[嘘]", @"[晕]", @"[折磨]", @"[衰]", @"[骷髅]", @"[敲打]", @"[再见]", @"[糗大了]", @"[委屈]", @"[吓]", @"[阴险]", @"[右哼哼]", @"[左哼哼]", @"[鄙视]", @"[擦汗]", @"[鼓掌]", @"[哈欠]", @"[坏笑]", @"[可怜]", @"[亲亲]", @"[扣鼻]", @"[快哭了]", @"[足球]", @"[爱你]", @"[爱心]", @"[抱拳]", @"[菜刀]", @"[NO]", @"[OK]", @"[瓢虫]", @"[啤酒]", @"[乒乓]", @"[强]", @"[拳头]", @"[弱]", @"[闪电]", @"[胜利]", @"[示爱]", @"[太阳]", @"[握手]", @"[西瓜]", @"[拥抱]", @"[月亮]", @"[便便]", @"[炸弹]", @"[猪头]", @"[玫瑰]", @"[差劲]", @"[蛋糕]", @"[刀]", @"[凋谢]", @"[饭]", @"[勾引]", @"[咖啡]", @"[篮球]", @"[礼物]", @"[心碎]", nil] arrayByAddingObjectsFromArray:customPic];
}
